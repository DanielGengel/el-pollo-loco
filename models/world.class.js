...
import { WorldRenderer } from "./worldRenderer.class.js";
import { ThrowManager } from "./throwManager.class.js";
...
export class World {
    ...
    constructor(canvas, keyboard) {
        ...
        IntervalHub.startInterval(this.throwManager.checkObjectThrown, 1000 / 60);
    }
    ...
    killEnemyWithBottle(enemy, bottle, bottleIndex) {
        ...
        this.throwManager.removeBottleAfterSplash(bottleIndex);
    }
